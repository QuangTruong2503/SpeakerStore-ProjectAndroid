...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView etProductBrand = findViewById(R.id.etProductBrand);
                ...
                if (etProductName.getText().toString().isEmpty()
                        ...
                        || etProductBrand.getText().toString().isEmpty() || imvProductImage.getDrawable()==null){
                    ...
                    addProductToDatabase(productName, productPrice, productQuantity, selectedImageBytes,productBrand);
                }

            }
        });
        LinearLayout menuSortBrand = findViewById(R.id.layoutSortBrandAdd);
    ...
    public boolean onContextItemSelected(MenuItem item){
        TextView etProductBrand = findViewById(R.id.etProductBrand);
        if (item.getItemId() == R.id.menu_JBL){
            etProductBrand.setText("JBL");
        }
        else if (item.getItemId() == R.id.menu_sony){
            etProductBrand.setText("Sony");
        }
        else if (item.getItemId() == R.id.menu_samsung){
            etProductBrand.setText("SamSung");
        }
    ...
    private void addProductToDatabase(String productName, double productPrice, int productQuantity, byte[] productImage,String productBrand) {
        ...
        values.put(DBHelper.COLUMN_BRAND, productBrand);
