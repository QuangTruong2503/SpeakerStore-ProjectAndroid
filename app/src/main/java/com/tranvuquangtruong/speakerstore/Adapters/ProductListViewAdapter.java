...
public class ProductListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView productBrand = view.findViewById(R.id.productBrandTextViewDelete);
        ImageView productImageView = view.findViewById(R.id.productImageViewDelete);

        ProductModel product = productList.get(position);
        productNameTextView.setText(product.getName());
        productPrice.setText("Giá: "+decimalFormat.format(product.getPrice())+ " vnđ");
        productQuantity.setText("SL: "+product.getQuantity());
