...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ProductModel getProductById(int productId) {
        ...
        Cursor cursor = db.query(
                TABLE_PRODUCTS,
                new String[]{COLUMN_ID, COLUMN_NAME, COLUMN_PRICE, COLUMN_QUANTITY, COLUMN_IMAGE,COLUMN_BRAND},
                COLUMN_ID + "=?",
                new String[]{String.valueOf(productId)},
                null,
                null,
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                ...
                int columnIndexBrand = cursor.getColumnIndex(COLUMN_BRAND);

                if (columnIndexId >= 0 && columnIndexName >= 0 && columnIndexPrice >= 0 &&
                        columnIndexQuantity >= 0 && columnIndexImage >= 0 && columnIndexBrand >= 0) {
                    ...
                    product = new ProductModel(
                            ...
                            cursor.getString(columnIndexBrand)
                    );
                }
